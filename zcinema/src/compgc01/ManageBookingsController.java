...
public class ManageBookingsController extends UserSceneController {
    ...
    @FXML
    Button logInButton, logOutButton, manageMoviesButton, manageBookingsButton, backButton;
    @FXML
    ...
    public void manageMoviesClick(ActionEvent event) throws IOException {
        ...
        ManageBookingsController controller = SceneCreator.getLoader().getController();
    ...
    void personaliseScene() throws IOException {
       ...
       lastNameLabel.setText(Main.getCurrentUser().getLastName());
        ...
        if (!Main.employeeMode) {
            ...
            if (SceneCreator.getSceneName().equals("UserScene.fxml")) {
        ...
        } else if (SceneCreator.getSceneName().equals("EditInfoScene.fxml")) {
